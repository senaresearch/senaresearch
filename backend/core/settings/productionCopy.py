...
AUTH_USER_MODEL = 'user_account.Promoter'
...
SECRET_KEY = 'zql&n+$4**_po=7z&o!qcbm=9%kx$dwcn&z@3i+usn1nraxgjs'
...
ALLOWED_HOSTS = ['https://senaresearch-dz.com', 'backend.senaresearch-dz.com']
CSRF_TRUSTED_ORIGIN = ['https://senaresearch-dz.com']

# Database
# It should be set on enviroment variable not here
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'senare58_database',
        'USER': 'senare58_admin',
        'PASSWORD': 'Aze1232000+',
        'HOST': 'localhost',
        'PORT': '3306',
...
EMAIL_HOST_USER = 'sena_research@gmail.com'
EMAIL_HOST_PASSWORD = 'senaPROJET198919932020'
