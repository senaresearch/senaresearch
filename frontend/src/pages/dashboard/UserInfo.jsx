...
const notifyWarning = (message) => toast.warning(message, {
  ...
  return (
    <div className='font-[Montserrat-Arabic] text-primary mt-16 lg:border-2 lg:rounded-xl lg:p-4 mx-auto lg:w-9/12 h-fit w-full bg-red-20'>
        ...
        <form onSubmit={profileEdit} className='bg-gray-30 mb-8
                        flex flex-col gap-6 px-6 sm:px-16 mx-auto items-center
            ...
            <button className='bg-primary lg:col-span1 lg:col-start-6 lg:col-end-7 font-bold text-sm leading-4 text-white py-3 px-12 mt-3 sm:mt-6 w-fit rounded-lg' type="submit">تحـــديث</button>
        </form>
    </div>
  )
}
