...
const AboutUs = () => {
  ...
  return (
    <div id={'aboutUs'} className='bg-white h-fit font-[Montserrat-Arabic] '>
      {/* WHO ARE WE */}
      <div className='flex flex-col justify-center items-center gap-16 w-4/6 mx-auto my-16 h-4/6'>
        <div>
          <h1 className=' font-semibold text-[50px] leading-[60.95px] text-primary '>? من نحن </h1>
          {/* TEXT HEAD ANIMATION */}
          <div className='hidden'></div>
        </div>
        <div className='flex flex-col justify-center items-center gap-10 '>
          <div className='w-[324px] border-[2px] border-primary '></div>
          <p className='font-medium text-[20px] leading-[41.08px] text-primary text-center font-[Montserrat-Arabic]'>
      ...
      <div className='relative  text-white'>
        <div id='whyAreUs' className='whyAreUs bg-cover bg-center bg-no-repeat flex flex-col gap-24 py-20' style={bgImage}>
          <div className='text-center'>
            <h1 className=' font-semibold text-[50px] leading-[60.95px] '>? لماذا نحن </h1>
            {/* TEXT HEAD ANIMATION */}
            <div className='hidden'></div>
          </div>
          {/* THREE FETUARES */}
          <div className='flex items-center justify-evenly'>
            <div className='flex flex-col justify-center items-center gap-4 font-semibold text-[20px] leading-[40.8px]'>
              <div className='  flex justify-center items-center w-[60px] h-[60px] rounded-full ' style={{background: 'radial-gradient(84.62% 84.62% at 50% 50%, #5A0057 0%, #9747FF 100%)'}} >
                <svg width="33" height="33" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M13.8855 21.5L18.9559 26.5704L29.1147 16.4296" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
              <p>أفضل النتائج</p>
            </div>
            <div className='flex flex-col justify-center items-center gap-4 font-semibold text-[20px] leading-[40.8px]'>
              <div className='  flex justify-center items-center w-[60px] h-[60px] rounded-full ' style={{background: 'radial-gradient(84.62% 84.62% at 50% 50%, #5A0057 0%, #9747FF 100%)'}} >
                <svg width="33" height="33" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M21.7866 19.4755C21.6074 19.4575 21.3924 19.4575 21.1953 19.4755C16.9312 19.3321 13.5449 15.8384 13.5449 11.5384C13.5449 7.14879 17.0924 3.58337 21.4999 3.58337C25.8895 3.58337 29.4549 7.14879 29.4549 11.5384C29.437 15.8384 26.0508 19.3321 21.7866 19.4755Z" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M12.8283 26.0866C8.49246 28.9891 8.49246 33.7191 12.8283 36.6037C17.7554 39.9004 25.8358 39.9004 30.7629 36.6037C35.0987 33.7012 35.0987 28.9712 30.7629 26.0866C25.8537 22.8079 17.7733 22.8079 12.8283 26.0866Z" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
              <p>أحسن الأستاذة</p>
            </div>
