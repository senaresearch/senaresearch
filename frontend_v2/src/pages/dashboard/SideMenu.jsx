    ...
    <div className='flex h-[93.5%]'>
      ...
      <div className={` ${isOpen ? 'right-0' : '-right-96'}
        ...
        <div className='flex gap-3 flex-col'>
          ...
          <Link to='info' className='text-right flex gap-2 px-2 pl-4 py-3 bg-primary rounded-xl text-white '>
          ...
          <Link to='services' className=' flex justify-end gap-2 px-2 pl-4 py-3 w-full rounded-xl text-primary hover:bg-gray-200'>
          ...
          <Link to='help' className=' flex justify-end gap-2 px-2 pl-4 py-3 w-full rounded-xl text-primary hover:bg-gray-200'>
            <p className=''>مساعدة</p>
