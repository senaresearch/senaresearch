...
const PaymentDetails = ({setStepNum, stepNum}) => {
    console.log(stepNum)
  return (
    <form className='w-full flex flex-col gap-10 items-center font-semibold text-[20px] leading-[24.38px] text-right font-[Montserrat-Arabic] ' action="" method="post">
        ...
        <div className='flex justify-evenly w-full'>
          <Link onClick={()=>setStepNum(stepNum-1)} to={''} className={` bg-primary px-14 flex rounded-md  mt-8 py-3 box-border text-[18px] text-white w-fit font-normal leading-[21.94pxpx] font-[Montserrat-Arabic] text-right `}>السـابق</Link>
